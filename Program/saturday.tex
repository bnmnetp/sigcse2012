...
% row 2    
    Chair: & 
    Nick Parlante and Julie Zelenski \textit{Stanford University}  \\[0.5em]
% row 3
    Participants: & 
    \multicolumn{2}{@{}l}{\parbox{3.75in}{Daniel Zingaro, \textit{University of Toronto}; Kevin Wayne, \textit{Princeton University}; Joshua Guerin, \textit{University of Kentucky}; Stephen Davies, \textit{University of Mary Washington}; Dave O'Hallaron, \textit{Carnegie Mellon University;} Debby Keen, \textit{University of Kentucky} and Zachary Kurmas, \textit{Grand Valley State}  }} \\[2em]
% row 4
...
% row 3
    Participants: & 
    \multicolumn{2}{@{}l}{\parbox{3.75in}{Helen Hu, \textit{Westminster College} and Clifton Kussmaul, \textit{Muhlenberg College} }} \\[2em]
% row 4
...
\end{longtable}
\begin{center}
\colorbox[gray]{0.75}{\textsf{Winner:  SIGCSE 2012 Best Paper Award}}
\end{center}
\newpage
\begin{longtable}{@{}p{0.75in}@{}p{3.25in}@{}r}
   {\sffamily\large\textbf{PAPERS}} &
...
{\centering {\Large\sffamily\textbf{Workshops}}
