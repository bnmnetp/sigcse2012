...
\begin{longtable}[l]{@{}p{1in}@{}p{3in}@{}r}
    ...
    {\sffamily\large\textbf{Exhibit Hall A}} \\
     \multicolumn{3}{@{\hspace*{0.25in}}p{4.75in}}{{\sffamily\textbf{Personal Robots for CS1: Next Steps for an Engaging Pedagogical Framework, }} Douglas Blank and Deepak Kumar} \\[.5em]
     \multicolumn{3}{@{\hspace*{0.25in}}p{4.75in}}{{\sffamily\textbf{An Interactive Undergraduate Data Mining Course with Industrial-Strength Projects and Hypertextbook,}} Ping Chen and Irene Chen} \\[.5em]
     \multicolumn{3}{@{\hspace*{0.25in}}p{4.75in}}{{\sffamily\textbf{Cyberlearning Environments with Emphasis on Social Approach and Collaboration,}} Jafar Saniie, Erdal Oruklu, and Tricha Anjali} \\[.5em]
     \multicolumn{3}{@{\hspace*{0.25in}}p{4.75in}}{{\sffamily\textbf{REU Site for Smart UAVs, }}  Saad Biaz and Wei-Shinn Ku} \\
\end{longtable}    
\vspace{0.5em}
\noindent\rule{5in}{0.02cm}
\vspace{0.5em}
