...
\end{tabular*}    
\begin{itemize}
     \item {{\sffamily\textbf{FRABJOUS CS - Framing a Rigorous Approach to Beauty and Joy for Outreach to Underrepresented Students in Computing at Scale, }} Dan Garcia, Tiffany Barnes, and Brian Harvey } 
     ...
     \item {{\sffamily\textbf{How to Broadening Participation and Scaling Up Computational Thinking by Bringing Game Design into Middle Schools, }} Alexander Repenning, Kris Gutierrez, Jeffrey Kidder, and David Webb} 
