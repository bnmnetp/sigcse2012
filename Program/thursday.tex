...
\begin{longtable}[l]{@{}p{1in}@{}p{2.75in}@{}r}
...
\begin{tabular}[l]{@{}p{1in}@{}p{3in}@{}r}
    {\sffamily\large\textbf{Project Showcase}} & 
    {\sffamily\large\textbf{NSF Showcase \#1}} & 
    {\sffamily\large\textbf{Exhibit Hall A}} \\
     \multicolumn{3}{@{\hspace*{0.25in}}p{4.75in}}{{\sffamily\textbf{Tools and Best Practices for Improving the Quality of Students' Commenting Skills}} Peter DePasquale, Michael Locasto, and Lisa Kaczmarczyk } \\ \\
     \multicolumn{3}{@{\hspace*{0.25in}}p{4.75in}}{{\sffamily\textbf{Student Participation in Humanitarian FOSS}} Heidi Ellis and Gregory Hislop } \\[.5em] 
     \multicolumn{3}{@{\hspace*{0.25in}}p{4.75in}}{{\sffamily\textbf{Computing in the Arts: A Model Curriculum}} Bill Manaris and Renee McCauley } \\[.5em] 
     \multicolumn{3}{@{\hspace*{0.25in}}p{4.75in}}{{\sffamily\textbf{Integrating Ethics Into Computer Science Courses: Looking for Statistically Significant Effects}}  Keith W. Miller, Michael Loui, Mary Tracy, and Ken Urban } \\[.5em]
\end{tabular}    
\newpage
...
% row 2    
    Chair: & 
    Ursula Wolz, \textit{Franklin W. Olin College of Engineering}  \\[0.2em]
% row 3
    Participants: & 
...
\begin{longtable}[l]{@{}p{1in}@{}p{3in}@{}r}
    ...
    {\sffamily\large\textbf{Exhibit Hall A}} \\
     \multicolumn{3}{@{\hspace*{0.25in}}p{4.75in}}{{\sffamily\textbf{Engaging African Americans in Computing through the Collaborative Creation of Musical Remixes}} Brian Magerko and Jason Freeman } \\[.5em]
     \multicolumn{3}{@{\hspace*{0.25in}}p{4.75in}}{{\sffamily\textbf{Building a K-12 Computing Pipeline in Alabama to Address Participation Diversity}} Jeff Gray, Mike Wyss, Shelia Cotten, and Shaundra Daily } \\[.5em]
     \multicolumn{3}{@{\hspace*{0.25in}}p{4.75in}}{{\sffamily\textbf{Computational Thinking in IT - A Scenario-based Approach}} Deborah Boisvert, Paula Velluto, Irene Bruno, and Charles Winer } \\[.5em]
     \multicolumn{3}{@{\hspace*{0.25in}}p{4.75in}}{{\sffamily\textbf{Process-Oriented Guided Inquiry Learning in Computer Science}}   Clifton Kussmaul, R. Libby, and Carl Salter } \\[.5em]
\end{longtable}    
\newpage
